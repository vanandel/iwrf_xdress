...
* \enum iwrf_prf_mode
*
* PRF mode - fixed or multiple-prt.
*
************************************************************************/
...
typedef enum iwrf_prf_mode {
 ...
 IWRF_PRF_MODE_STAGGERED_2_3 = 2, /**< staggered dual PRT, 2/3 ratio */
 IWRF_PRF_MODE_STAGGERED_3_4 = 3, /**< staggered dual PRT, 3/4 ratio */
 IWRF_PRF_MODE_STAGGERED_4_5 = 4, /**< staggered dual PRT, 4/5 ratio */
 IWRF_PRF_MODE_MULTI_PRT = 5,     /**< staggered more than 2 PRT's */
...
typedef enum iwrf_follow_mode {
 ...
 IWRF_FOLLOW_MODE_MOON = 7, /**< Radar is tracking the sun */
...

{
 ...
 fl32 unused[458]; /**< for future expansion */
...
* In the CHILL aquisition server, these corrections are added to the 
* angles provided by the fiber optic interface.
*
************************************************************************/
...
typedef struct iwrf_ts_processing {
 ...
 fl32 prt_usec;  /**< first PRT in microseconds */
 fl32 prt2_usec; /**< optional second PRT used in dual PRT/PRF modes */
...
*
* Measured transmit sample at RF - gives the shape of the burst
...
typedef struct iwrf_calibration {
 ...
 si32 unused[67]; /**< for future expansion */ 
...
typedef struct iwrf_pulse_header {
 ...
 si32 hv_flag;     /**< Used in all. 1 if H, 0 if V, 3 if SLANT45
				 	**  \ref iwrf_pulse_polarization */
